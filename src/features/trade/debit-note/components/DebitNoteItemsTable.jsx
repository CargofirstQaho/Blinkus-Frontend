  ...
  return (
    <tr style={{ background: idx % 2 === 0 ? '#fff' : '#F0F7FF' }}>
      ...
      <td className="px-1 py-1" style={{ minWidth: 80 }}>
        <Controller control={control} name={`lineItems.${idx}.rate`} render={({ field: { value, onChange, onBlur, ref } }) => (
          <div>
...
export default function DebitNoteItemsTable({ control, errors }) {
