...
export default function PurchaseOrderEntryPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 space-y-8">
      <div>
        <h1 className="text-2xl font-extrabold" style={{ color: BRAND }}>Purchase Order</h1>
        <p className="text-sm mt-1" style={{ color: MUTED }}>
          Create and manage your purchase order documents.
        </p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <button
          onClick={() => navigate('/trade/domestic/purchase-order/form')}
        ...
        >
          ...
          <div>
            <p className="font-bold text-base text-white">Generate New Purchase Order</p>
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: MUTED }}>
              See and continue editing all your saved Purchase Order drafts.
            </p>
          </div>
