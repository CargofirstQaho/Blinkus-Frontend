...
export default function CommercialInvoiceEntryPage() {
  const navigate = useNavigate();

  return (
    <div className="max-w-4xl mx-auto px-4 py-6 space-y-8">
      <div>
        <h1 className="text-2xl font-extrabold" style={{ color: BRAND }}>Commercial Invoice</h1>
        <p className="text-sm mt-1" style={{ color: MUTED }}>
          Create and manage your commercial invoice documents.
        </p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <button
          onClick={() => navigate('/trade/international/commercial-invoice/form')}
        ...
        >
          ...
          <div>
            <p className="font-bold text-base text-white">Generate New Commercial Invoice</p>
            <p className="text-sm mt-1" style={{ color: '#BFDBFE' }}>
              Start creating a new Commercial Invoice.
            </p>
          </div>
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: MUTED }}>
              See and continue editing all your saved Commercial Invoice drafts.
            </p>
          </div>
