...
export default function ComingSoonOverlay() {
  return (
    <div
      ...
      style={{
        background:           'linear-gradient(145deg, rgba(8,16,50,0.70) 0%, rgba(12,28,76,0.66) 100%)',
    ...
    >
      <div className="text-center px-6 py-8 max-w-md mx-auto">
        ...
        <h3 className="font-bold text-base text-white/90 mb-2 leading-snug">
          Contract Drafting Platform Coming Soon
        </h3>

        <p className="text-xs leading-relaxed mb-5" style={{ color: 'rgba(255,255,255,0.52)' }}>
          AI-powered international trade agreement generation is currently under development.
        </p>
